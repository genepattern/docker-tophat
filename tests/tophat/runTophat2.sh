...
TRANSCRIPTOME_DIR=/Users/liefeld/GenePattern/gp_dev/docker/docker-tophat/tests/tophat/transcriptome_index/
INPUT_FILE_DIRECTORIES=/Users/liefeld/GenePattern/gp_dev/docker/docker-tophat/tests/tophat/data

perl $TASKLIB/tophat_wrapper.pl  --tophatDir  $TOPHATDIR  --samtoolsDir $SAMTOOLSDIR  --bowtieDir $BOWTIEDIR --libdir  $TASKLIB  --index $INDEXDIR  --pair1  $INPUT_FILE_DIRECTORIES/reads.pair.1.list.txt  --pair2  $INPUT_FILE_DIRECTORIES/reads.pair.2.list.txt  --mateDist  50  --mateStd  --readEditDist  --readGapLength  --oprefix  SRR1039508  --gtf  --transcriptomeIndex  $TRANSCRIPTOME_DIR  --juncs  --transcriptomeOnly  yes  --minALen  8  --maxSpliceM  0  --minILen  --maxILen  500000  --maxInsLen  3  --maxDelLen  3  --maxMHit  20  --readMis  2  --maxTHit  --fAnchorLen  20  --fReadMis  2  --fusion  --  --library-type  fr-unstranded  --no-coverage-search  -p  6
