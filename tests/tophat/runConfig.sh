...
INPUT_FILE_DIRECTORIES=/Users/liefeld/GenePattern/gp_dev/docker/docker-tophat/tests/tophat/indices/annotation


TASKLIB=$PWD/src
INPUT_FILE_DIRECTORIES=$PWD/indices/annotation
